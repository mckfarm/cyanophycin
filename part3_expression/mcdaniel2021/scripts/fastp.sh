...
#SBATCH -N 1
#SBATCH --mem=10G
#SBATCH --output=/projects/b1052/mckenna/cyanophycin/mcdaniel2021/scripts/fastp_%A_%a.out
#SBATCH --error=/projects/b1052/mckenna/cyanophycin/mcdaniel2021/scripts/fastp_%A_%a.err
#SBATCH --array=1-7
...
param_store=/projects/b1052/mckenna/cyanophycin/mcdaniel2021/scripts/fastp.txt
